...
export default function RepurposeSection() {
    ...
    let ctx = gsap.context(() => {
      ...
      const tl = gsap.timeline({
        scrollTrigger: {
          ...
          start: "top top",
          end: "+=400%", // Much longer scroll duration to make it stay put
          pin: true,
          scrub: 1.0, // Tighter scrub mapping
          invalidateOnRefresh: true,
        },
      });

      // Pause at the very beginning so the user sees "Drab" before anything moves
      tl.to({}, { duration: 40 });
      ...
      tl.to(
        ...
        "<20", // Start fading out drab a bit gracefully after slider moves
      );
      ...
      tl.to(
        ...
        "<25",
      ); // Bring in fab smoothly

      // Pause at the end so the user sees the completed "Fab" state before unpinning
      tl.to({}, { duration: 40 });
    }, containerRef);
  ...
  return (
    <section
      ref={containerRef}
      id="repurpose"
      className="relative w-full min-h-[100dvh] z-30 bg-sky-50 text-slate-800 border-t border-slate-200 overflow-hidden pointer-events-auto shrink-0 flex"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full min-h-screen py-12 lg:py-20 flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-16">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center relative min-h-[350px] sm:min-h-[400px] lg:min-h-[50vh] z-10 shrink-0">
          ...
          <div className="drab-content absolute inset-0 flex flex-col justify-center items-center lg:items-start text-center lg:text-left z-10 p-2">
            ...
            <p className="font-sans text-slate-600 text-xs sm:text-base md:text-lg leading-relaxed max-w-md lg:max-w-lg mb-4 lg:mb-8">
              Well-made furniture shouldn't end up in a landfill. We gladly
              accept donations of pieces and give them a fresh update.
            </p>
          </div>
          ...
          <div className="fab-content opacity-0 invisible translate-y-8 absolute inset-0 flex flex-col justify-center items-center lg:items-start text-center lg:text-left z-0">
            ...
            <p className="font-sans text-slate-800 text-xs sm:text-base md:text-lg leading-relaxed max-w-md lg:max-w-lg font-medium mb-6 lg:mb-10">
              Love your grandma's armchair but hate the pattern? We can sand,
              stain, and apply expressive art to your favorite old pieces.
            </p>
